...
const MonitoringEvaluationStaff = () => {
    ...
    const ListData = async (filters) => {
        setIsLoading(true)
        let url = `${baseUrl}monitoring_evaluation_staff/list${filterUrl(filters)}`;
        try {
    ...
    let tableData = {
        ...
        action: {
            ...
            "update": null,
            "delete": null,
            "view": '/app/monitoring-evaluation-staff/view'
        },
        isPagination: true,
        eventLister: {
            ListData,
    ...
    return (
        <Page
            title="Khushaal Bachpan Abhiyan/Monitoring Evaluation Form for Staff"
            btnTitle=""
            href=""
            className={classes.root}
            csvTitle="Monitoring Evaluation Staff"
            downloadUrl="monitoring_evaluation_staff/csv"
            csvFilters={{ ...filters }}
...
export default MonitoringEvaluationStaff;