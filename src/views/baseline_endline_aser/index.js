...
export const BaselineEndline = () => {
  ...
  const ListData = async (filters) => {
    setIsLoading(true)
    let url = `${baseUrl}baseline-endline/list${filterUrl({ ...filters, "type": '1' })}`;
    try {
  ...
  let tableData = {
    ...
    tableConfig: [
      ...
      {
        "key": "math_practice_capability",
        "title": "Math Practice  capability",
        "type": "string",
        "filter_data": [
          { name: "Beginner", id: "1" },
          { name: "Single Digit Number (1-9)", id: "2" },
          { name: "Two Digit Number(10-99)", id: "3" },
  ...
  const filterData = {
    ...
    fields: [
      ...
      {
        name: "reading_capability", type: "select", title: "Reading capability",
        optionsArray: [
          { name: "Beginner", id: "1" },
          { name: "Letter", id: "2" },
          { name: "Word", id: "3" },
      ...
      {
        name: "math_practice_capability", type: "select", title: "Math Practice  capability",
        optionsArray: [
          { name: "Beginner", id: "1" },
          { name: "Single Digit Number (1-9)", id: "2" },
          { name: "Two Digit Number(10-99)", id: "3" },
  ...
  return (
    <Page
      title="BSA ASER Baseline Endline"
      btnTitle=""
      href=""
