...
const GapAssessmentTwo = () => {
    ...
    const ListData = async (filters) => {
        setIsLoading(true)
        let url = `${baseUrl}gap_assessment_two/list${filterUrl(filters)}`;
        try {
    ...
    let tableData = {
        ...
        action: {
            ...
            "update": null,
            "delete": null,
            "view": "/app/gap-assessment-two/view"
        },
        isPagination: true,
        eventLister: {
            ListData,
    ...
    return (
        <Page
            title="Khushaal Bachpan Abhiyan/Gap Assessment Two"
            btnTitle=""
            href=""
            className={classes.root}
            csvTitle="Gap Assessment Two"
...
export default GapAssessmentTwo;